...
export const msalConfig = {
    auth: {
        ...
        redirectUri: 'https://localhost:44462', // You must register this URI on Azure Portal/App Registration. Defaults to window.location.origin
    ...
    system: {
        loggerOptions: {
            loggerCallback: (level, message, containsPii) => {
                ...
                if (false) {//Disabled console of react azure
                    switch (level) {
                        case LogLevel.Error:
